...
from datetime import timedelta #ProjectSpecific
from dotenv import load_dotenv #ProjectSpecific
import os #ProjectSpecific

load_dotenv #ProjectSpecific
...
SECRET_KEY = 'django-insecure-49b0z9r=4^%+&j_wfkpl-mb-yd3gs-u40xj3e+=)fi%&-fugcf'
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware' #ProjectSpecific
]
